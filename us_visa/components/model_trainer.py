...
class ModelTrainer:
    def __init__(
        ...
        model_trainer_config : Configuration of Model Trainer
        """
    ...
    def get_model_object_and_report(
        ...
        Desciption   :  This function uses neuro mf to get the best model object and report of the best model

        Output       :  Returns metric artifact object and best model object
        On Failure   :  Write an exception log and raises an exception
        """
        try:
            logging.info("Using neuro mf to get the best model object and report")
            model_fatory = ModelFactory(
            ...
            best_model_detail = model_fatory.get_best_model(
                X=x_train,
                y=y_train,
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        Output       :  Returnd Model tariner Artifact
        On Failure   :  Write an Exception log and raised an exception
        """
        try:
            ...
            logging.info("Created usvisa model object with preproccessor and model")

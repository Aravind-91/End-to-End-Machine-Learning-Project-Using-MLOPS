...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        Description  :  This method validates no of columns
    ...
    def detect_dataset_drift(
        ...
        Output        :   Returns bool value based validation result
        On Failure    :   writes an exception and raises an exception
        """
        try:
            ...
            write_yaml_file(
                self.data_validation_config.drift_report_file_path, json_report, True
            )
